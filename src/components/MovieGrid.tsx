...
export const MovieGridSkeleton: React.FC = () => (
    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 p-8 max-w-[1248px] mx-auto">
        {[...Array(12)].map((_, i) => (
...
const MovieGrid: React.FC = () => {
    ...
    return (
        <div className={`movie-container grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 p-5 max-w-[1248px] w-full mx-auto ${!isHome ? 'pt-5' : ''}`}>
